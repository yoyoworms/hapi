export const RPC_METHODS = {
    ...
    StartCodexAccountLogin: 'startCodexAccountLogin',
    GetCodexAccountLoginStatus: 'getCodexAccountLoginStatus',
    AddCodexApiEndpoint: 'addCodexApiEndpoint',
    SetDefaultCodexAccount: 'setDefaultCodexAccount',
    RemoveCodexAccount: 'removeCodexAccount',
    ...
    ListClaudeModelsForMachine: 'listClaudeModelsForMachine',
