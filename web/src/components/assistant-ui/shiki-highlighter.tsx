...
export function SyntaxHighlighter(props: SyntaxHighlighterProps) {
    ...
    return (
        <div data-hapi-code-body="true" className={`aui-md-codeblock min-w-0 w-full max-w-full overflow-y-clip rounded-b-xl bg-[var(--app-code-bg)] ${codeWrap ? '' : 'overflow-x-auto'}`}>
            <pre
