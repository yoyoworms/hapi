export default {
  ...
  'scratchlist.modeLockedByAttachments': '请先移除输入框附件，再复制暂存条目',
  ...
  'settings.chat.inputMode': '消息输入框',
  'settings.chat.inputMode.native': '兼容模式（推荐）',
  'settings.chat.inputMode.rich': '富文本提及（实验性）',
