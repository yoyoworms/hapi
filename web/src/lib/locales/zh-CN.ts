export default {
  ...
  'composer.abort': '中止',
  'composer.abortFailed': '未能停止任务，任务仍在运行。请重试或归档该会话。',
  'composer.switchRemote': '切换到远程模式',
  'composer.attach': '添加文件',
  'composer.attachUnavailableInactive': '会话恢复运行后才能添加附件',
  'composer.attachBlockedBySchedule': '请先取消定时发送，再添加附件',
  'composer.attachmentAddFailed': '一个或多个附件添加失败。',
  ...
  'scratchlist.modeLockedByAttachments': '请先移除附件，再切换发送目标',
  'scratchlist.modeLockedByDraft': '请先清空当前草稿，再复制暂存条目',
  ...
  'session.action.share': '分享链接',
  'session.share.title': '分享此会话',
  'session.share.description': '拿到链接的人无需登录即可打开并使用此会话，且只能看到这一个会话。',
  'session.share.notShared': '此会话尚未分享。',
  'session.share.create': '创建分享链接',
  'session.share.copy': '复制链接',
  'session.share.copied': '链接已复制',
  'session.share.revoke': '撤销链接',
  'session.share.warning': '撤销链接即可立即切断访问。',
  ...
  'newSession.codexAccount.title': 'Codex 账号',
  'newSession.codexAccount.description': '每台 Runner 独立保存账号；切换机器会读取目标机器，不会修改它的系统 Codex 登录。',
  'newSession.codexAccount.loading': '正在加载 Codex 账号…',
  'newSession.codexAccount.loadFailed': '加载 Codex 账号失败',
  'newSession.codexAccount.runnerUpdateRequired': '这台机器的 Runner 版本不支持 HAPI 账号管理。更新该机器的 Runner 后才能选择或添加账号；当前创建 Codex 会话将使用这台机器的系统 Codex 登录。',
  'newSession.codexAccount.add': '添加账号',
  'newSession.codexAccount.startingLogin': '正在启动…',
  'newSession.codexAccount.loginFailed': 'Codex 账号登录失败',
  'newSession.codexAccount.defaultFailed': '更新默认 Codex 账号失败',
  'newSession.codexAccount.default': '默认',
  'newSession.codexAccount.current': '当前使用',
  'newSession.codexAccount.signedOut': '未登录',
  'newSession.codexAccount.makeDefault': '设为默认',
  'newSession.codexAccount.deviceSetupTitle': '先开启设备代码授权',
  'newSession.codexAccount.deviceSetupDescription': '在 ChatGPT 的安全设置中，为 Codex 开启“设备代码授权”。如果未开启，OpenAI 授权页只会显示错误提示，不会出现设备码输入框。',
  'newSession.codexAccount.deviceOpenSettings': '打开 ChatGPT 安全设置',
  'newSession.codexAccount.deviceContinue': '已开启，继续授权',
  'newSession.codexAccount.deviceTitle': '使用 ChatGPT 登录',
  'newSession.codexAccount.deviceDescription': '在验证页面输入下方的一次性验证码。如果页面没有输入框，请先在 ChatGPT 安全设置中开启设备代码授权，然后重新添加账号。',
  'newSession.codexAccount.waiting': '正在等待授权…',
  'newSession.codexAccount.addEndpoint': '添加 API',
  'newSession.codexAccount.endpointLabel': '名称，例如：公司代理',
  'newSession.codexAccount.endpointBaseUrl': 'API Base URL，例如：https://api.example.com/v1',
  'newSession.codexAccount.endpointApiKey': 'API Key',
  'newSession.codexAccount.endpointModel': '模型 ID',
  'newSession.codexAccount.endpointSecurity': '密钥经当前 HAPI HTTPS 连接发送一次，仅保存于此 Runner 的权限保护文件，不写入 Hub 数据库。',
  'newSession.codexAccount.endpointAdd': '保存端点',
  'newSession.codexAccount.endpointAdding': '正在保存…',
  'newSession.codexAccount.endpointFailed': '添加 Codex API 端点失败',
  'session.action.switchCodexAccount': '切换 Codex 账号 / API',
  'codexAccountSwitch.title': '切换 Codex 账号 / API',
  'codexAccountSwitch.description': '当前进程会安全停止；原 Codex thread 会复制到新身份的隔离目录后继续，不会丢失本会话上下文。',
  'codexAccountSwitch.noMachine': '此会话没有记录 Runner，无法切换。',
  'codexAccountSwitch.confirm': '切换并继续',
  'codexAccountSwitch.switching': '正在切换…',
  'codexAccountSwitch.failed': '切换 Codex 身份失败',
  'status.accountWindow': '5小时 {value}',
  'status.accountWeekly': '7天 {value}',
  'newSession.sandbox': '沙箱',
  'newSession.sandbox.title': '在 Docker 沙箱中运行',
  'newSession.sandbox.desc': '仅挂载项目目录，在隔离容器中启动会话。',
  'settings.usage.title': '使用限额',
  'settings.usage.plan': '订阅计划',
  'settings.usage.fiveHour': '5小时',
  'settings.usage.sevenDay': '7天总量',
  'settings.usage.sevenDayOpus': '7天 Opus',
  'settings.usage.sevenDaySonnet': '7天 Sonnet',
  'settings.usage.resetsIn': '重置于',
  'settings.usage.unavailable': '无法获取使用数据',
