export default {
  ...
  'composer.abortFailed': 'Could not stop the task. It is still running; retry or archive the session.',
  'composer.switchRemote': 'Switch to remote mode',
  'composer.attach': 'Attach file',
  'composer.attachUnavailableInactive': 'Attachments require an active session',
  'composer.attachBlockedBySchedule': 'Clear the scheduled send before attaching files',
  'composer.attachmentAddFailed': 'One or more attachments could not be added.',
  ...
  'scratchlist.modeLockedByAttachments': 'Remove attachments before switching destination',
  'scratchlist.modeLockedByDraft': 'Clear the current draft before copying an entry',
  ...
  // Local deployment capabilities retained across upstream sync
  ...
  'session.action.share': 'Share link',
  'session.share.title': 'Share this session',
  'session.share.description': 'Anyone with the link can open and use this session without logging in. They only see this one session.',
  'session.share.notShared': 'This session is not shared yet.',
  'session.share.create': 'Create share link',
  'session.share.copy': 'Copy link',
  'session.share.copied': 'Link copied',
  'session.share.revoke': 'Revoke link',
  'session.share.warning': 'Revoke the link to immediately cut off access.',
  ...
  'newSession.codexAccount.title': 'Codex account',
  'newSession.codexAccount.description': 'Accounts are stored independently on each runner. Switching machines reads the target machine without changing its system Codex login.',
  'newSession.codexAccount.loading': 'Loading Codex accounts…',
  'newSession.codexAccount.loadFailed': 'Failed to load Codex accounts',
  'newSession.codexAccount.runnerUpdateRequired': 'This machine’s runner does not support HAPI account management. Update that runner to select or add accounts. Until then, new Codex sessions use this machine’s system Codex login.',
  'newSession.codexAccount.add': 'Add account',
  'newSession.codexAccount.startingLogin': 'Starting…',
  'newSession.codexAccount.loginFailed': 'Codex account login failed',
  'newSession.codexAccount.defaultFailed': 'Failed to update the default Codex account',
  'newSession.codexAccount.default': 'default',
  'newSession.codexAccount.current': 'current',
  'newSession.codexAccount.signedOut': 'signed out',
  'newSession.codexAccount.makeDefault': 'Make default',
  'newSession.codexAccount.deviceSetupTitle': 'Enable device-code authorization first',
  'newSession.codexAccount.deviceSetupDescription': 'In ChatGPT Security settings, enable device-code authorization for Codex. Otherwise, the OpenAI authorization page shows an error instead of the code entry field.',
  'newSession.codexAccount.deviceOpenSettings': 'Open ChatGPT Security settings',
  'newSession.codexAccount.deviceContinue': 'Enabled, continue',
  'newSession.codexAccount.deviceTitle': 'Sign in with ChatGPT',
  'newSession.codexAccount.deviceDescription': 'Enter the one-time code below on the verification page. If there is no code field, enable device-code authorization in ChatGPT Security settings, then add the account again.',
  'newSession.codexAccount.waiting': 'Waiting for authorization…',
  'newSession.codexAccount.addEndpoint': 'Add API',
  'newSession.codexAccount.endpointLabel': 'Name, e.g. Company proxy',
  'newSession.codexAccount.endpointBaseUrl': 'API Base URL, e.g. https://api.example.com/v1',
  'newSession.codexAccount.endpointApiKey': 'API key',
  'newSession.codexAccount.endpointModel': 'Model ID',
  'newSession.codexAccount.endpointSecurity': 'The key is sent once over this HAPI HTTPS connection and stored only on the runner, never in the Hub database.',
  'newSession.codexAccount.endpointAdd': 'Save endpoint',
  'newSession.codexAccount.endpointAdding': 'Saving…',
  'newSession.codexAccount.endpointFailed': 'Failed to add Codex API endpoint',
  'session.action.switchCodexAccount': 'Switch Codex account / API',
  'codexAccountSwitch.title': 'Switch Codex account / API',
  'codexAccountSwitch.description': 'The current process will stop safely. HAPI copies the original Codex thread into the selected identity’s isolated home and resumes it there.',
  'codexAccountSwitch.noMachine': 'This session has no recorded runner and cannot be switched.',
  'codexAccountSwitch.confirm': 'Switch and continue',
  'codexAccountSwitch.switching': 'Switching…',
  'codexAccountSwitch.failed': 'Failed to switch Codex identity',
  'status.accountWindow': '5h {value}',
  'status.accountWeekly': '7d {value}',
  ...
  'settings.usage.plan': 'Plan',
  'settings.usage.fiveHour': '5-Hour',
  'settings.usage.sevenDay': '7-Day Total',
  'settings.usage.sevenDayOpus': '7-Day Opus',
  'settings.usage.sevenDaySonnet': '7-Day Sonnet',
  'settings.usage.resetsIn': 'resets in',
  'settings.usage.unavailable': 'Usage data unavailable',
