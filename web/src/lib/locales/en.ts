export default {
  ...
  'scratchlist.modeLockedByAttachments': 'Remove attachments before copying an entry',
  ...
  'settings.chat.inputMode': 'Message editor',
  'settings.chat.inputMode.native': 'Compatible (recommended)',
  'settings.chat.inputMode.rich': 'Rich mentions (experimental)',
